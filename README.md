...
### Phase 2 — Fraud Graph Integration (Neo4j)

- Build transaction graph dataset
- Extract risk signals (shared device/IP, suspicious clusters)
- Attach derived risk signals into Qdrant payload
- Let agents incorporate network risk into arguments

### Phase 3 — Policy-Aware RAG

- Ingest policy documents
- Retrieve policy clauses for judge decisions
- Output verdict with:
	- evidence from similar applicants
	- evidence from compliance policy
...
- Audit storage (transcripts, evidence snapshots)
